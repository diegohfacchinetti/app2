 ...
 * @author 1513 IRON
 */
public class V_Produto_Listar extends javax.swing.JFrame {

    /**
     * Creates new form V_Produto_Listar
     */
    public V_Produto_Listar() {
        initComponents();
        this.prencheTabela();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(V_Produto_Listar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new V_Produto_Listar().setVisible(true);
            }
        });
    }
